...
class MilanoTableSeeder extends Seeder
{
    public function run()
    {
        ...
        if (Config::where('name', 'credits')->first() == null) {
            $c = new Config();
            $c->name = 'credits';
            $c->value = sprintf('<p>Un progetto di<br/><img src="%s" alt="Agenzia per lo Sviluppo Locale di San Salvario"><img src="%s" alt="Milano 2035"></p><p>Con il sostegno di<br/><img src="%s" alt="Welfare in Azione"><img src="%s" alt="Fondazione Cariplo"></p><p><a href="http://www.milano2035.it">www.milano2035.it</a></p>', Vite::asset('resources/images/agenziasansalvario.jpg'), Vite::asset('resources/images/milano2035.png'), Vite::asset('resources/images/welfareinazione.jpg'), Vite::asset('resources/images/fondazione_cariplo.png'));
            $c->save();
        }
        ...
        if (Config::where('name', 'cover_link')->first() == null) {
            $c = new Config();
            $c->name = 'cover_link';
            $c->value = Vite::asset('resources/images/cartolina_milano.png');
            $c->save();
        }
