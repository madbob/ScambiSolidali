...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <p>
                I dati personali dell’utente saranno trattati dai dipendenti che operano sotto la diretta autorità del rispettivo "Responsabile del trattamento" e che sono stati designati Incaricati del trattamento ed hanno ricevuto, al riguardo, adeguate istruzioni operative. I Responsabili o gli Incaricati designati riceveranno adeguate istruzioni operative, con particolare riferimento all´adozione delle misure minime di sicurezza, al fine di poter garantire la riservatezza e la sicurezza dei dati. Presso la nostra sede è possibile acquisire l´elenco dei responsabili del trattamento nominati. L’Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS adotta ed osserva specifiche misure di sicurezza al fine di prevenire la perdita dei dati conferiti, eventuali usi illeciti o non corretti dei medesimi ed accessi non autorizzati. Salvi i limiti di Legge, l’Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS non è in alcun modo responsabile delle perdite economiche, nè dei danni diretti od indiretti eventualmente subiti dall´Utente o da terzi in conseguenza dell´utilizzo del sito o del proprio servizio.
            </p>
            ...
            <p>
                L’utilizzo del servizio {{ env('APP_NAME') }} è regolato nei termini ed alle condizioni di seguito riportate.<br/>
                La fruizione del servizio e dei contenuti offerti da {{ env('APP_NAME') }} comporta e presuppone l’integrale conoscenza e l’incondizionata accettazione delle clausole sottoelencate.
            </p>

            <h2>1 - INDIVIDUAZIONE DEL SERVIZIO E DEI CONTENUTI OFFERTI DA {{ env('APP_NAME') }}</h2>
            <p>
                Ass. Agenzia per lo sviluppo locale di San Salvario onlus, con sede legale in via Morgari 14, 10125, Torino, P.I. ………, consente ai destinatari del proprio servizio di immettere, pubblicare e consultare gratuitamente annunci online di natura NON commerciale, al fine di facilitare la donazione di oggetti, competenze e tempo/lavoro volontario, destinate a persone in condizione di fragilità economica e sociale e/o ad organizzazioni non profit che operano nell’ambito della lotta all’esclusione sociale.
            </p>
            ...
            <p>
                ...
                L'Utente prende atto che {{ env('APP_NAME') }} non effettuerà alcun controllo preventivo sul contenuto degli annunci immessi in rete, né svolgerà alcuna attività di intermediazione sugli eventuali accordi intercorrenti tra gli Utenti medesimi per il conferimento del bene donato.<br/>
                Questi ultimi si assumono, pertanto, la piena ed esclusiva responsabilità, verso {{ env('APP_NAME') }} e verso i terzi, del comportamento tenuto.<br/>
                L'Utente fa uso del servizio messo a disposizione da {{ env('APP_NAME') }} nella consapevolezza che quest'ultima non garantisce alcunché in ordine alla veridicità del contenuto degli annunci o al buon esito delle donazioni.<br/>
                Pubblicando il proprio annuncio su {{ env('APP_NAME') }} l'utente autorizza l’ass. Agenzia per lo sviluppo locale di San Salvario ONLUS e le organizzazioni partner ad adoperarsi affinché il contenuto dell'annuncio venga reso visibile ed accessibile agli utenti della rete anche mediante successiva indicizzazione su motori di ricerca, mediante pubblicazione su altri siti e social network, al fine di promuovere con più efficacia le inserzioni dei propri utenti e facilitare la buona riuscita della donazione.<br/>
                L’Utente si impegna a non fruire dei servizi fornitigli da Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS e/o dal sito {{ env('APP_NAME') }} in modo improprio o contrario alle disposizioni di Legge e regolamentari ed alle norme di Etica e di Buon uso dei servizi di rete.<br/>
                In particolare, l’Utente si impegna a non trasmettere, tramite {{ env('APP_NAME') }}, materiale di natura offensiva, calunniosa, diffamatoria, pornografica, pedopornografica, volgare, oscena, blasfema, o comunque contraria ai principi dell’ordine pubblico e del buon costume.<br/>
                L'Utente è consapevole che l'indirizzo di posta elettronica reso noto su {{ env('APP_NAME') }} potrà valere quale mezzo di comunicazione a distanza.<br/>
                ...
                L'Utente dichiara di utilizzare il servizio offerto da {{ env('APP_NAME') }} nella consapevolezza di poter incontrare link che possono rinviare a pagine web su cui {{ env('APP_NAME') }} non ha alcun controllo e sul cui contenuto non assume alcuna responsabilità.<br/>
                ...
                L'Utente si obbliga a non incoraggiare, commettere, favorire e/o agevolare in qualunque modo, mediante gli spazi messi a disposizione da {{ env('APP_NAME') }}, azioni criminali e comportamenti illeciti in generale. L'Utente si obbliga a non pregiudicare l'uso ed il godimento del Servizio degli altri utenti.<br/>
                Mediante l’utilizzo delle risorse offerte da {{ env('APP_NAME') }}, l'Utente si obbliga a non riprodurre, trascrivere, duplicare, distribuire, modificare o comunicare, senza averne diritto, materiale protetto dal diritto di autore ed a rispettare, in generale, qualsivoglia disposizione di cui alla L. n. 633/1941 e succ. modd. ( c. d. “LdA”).<br/>
                ...
                Resta ferma l’insussistenza di qualsivoglia attività di intermediazione tra la domanda e l’offerta di lavoro da parte di {{ env('APP_NAME') }}, dell’Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS e dei suoi partner.<br/>
                {{ env('APP_NAME') }} si limita, infatti, ad offrire all’Utente uno spazio web per la pubblicazione dei propri annunci.<br/>
                ...
                L'Utente dichiara in particolare di usufruire del servizio messo a disposizione da {{ env('APP_NAME') }} SENZA ALCUNA FINALITA’ COMMERCIALE. Beni e servizi trattati da {{ env('APP_NAME') }} non avranno MAI essere oggetto di transazione commerciale o comportare forme di pagamento di corrispettivo anche non monetario.
            </p>

            <h2>3 – ESONERO DA RESPONSABILITA’ E CLAUSOLA DI MANLEVA</h2>
            <p>
                L’Utente, quale necessaria conseguenza della propria piena ed esclusiva responsabilità eventualmente derivante dalla violazione di Leggi, regolamenti e delle presenti condizioni generali, dichiara espressamente di esonerare {{ env('APP_NAME') }} da qualsivoglia responsabilità, civile e penale, riconoscendone, fin d’ora, il difetto di legittimazione passiva in giudizio.<br/>
                In particolare, l’Utente si obbliga a manlevare {{ env('APP_NAME') }}, sostanzialmente e processualmente, da qualsiasi pregiudizio, perdita, danno, responsabilità, costo, o­nere o spesa, incluse le spese legali, derivanti da pretese o da azioni avanzate da terzi, in qualunque sede ed a qualunque titolo, in conseguenza di annunci od opinioni immessi in rete dall’Utente mediante l’utilizzo improprio delle risorse offerte da {{ env('APP_NAME') }} e dalle interazioni e transazioni di beni e servizi ad esso conseguenti.
            </p>

            <h2>4 – DIRITTI RISERVATI</h2>
            <p>
                {{ env('APP_NAME') }} è titolare di tutti i servizi ed i contenuti messi a disposizione dell’Utente tramite il proprio sito web.<br/>
            ...
            <p>
                I dati personali forniti dall’Utente saranno raccolti ed utilizzati da {{ env('APP_NAME') }} nel pieno rispetto della normativa di cui al D.Lgs. n. 196 del 30 giugno 2003 ( c.d. “ Codice in materia di protezione dei dati personali “ ).<br/>
            ...
            <ul>
                ...
                <li>costituisce unico elemento da comunicare obbligatoriamente il conferimento di un valido indirizzo di posta elettronica.</li>
                <li>l’eventuale rifiuto di comunicare il predetto dato comporterà l’impossibilità di usufruire del servizio richiesto.</li>
                <li>gli indirizzi di posta elettronica forniti dall'utente potranno essere condivisi con soggetti terzi esclusivamente previa autorizzazione dell'utente stesso.</li>
            ...
            <p>
                La presente informativa sulla Privacy è aggiornata al….. L’ Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS si riserva il diritto di modificare la suddetta informativa previo avviso all’Utente, da effettuarsi mediante pubblicazione della versione aggiornata all’interno del sito.
            </p>

            <h2>6 - REGOLE PER LA PUBBLICAZIONE DEGLI ANNUNCI</h2>
            <ol>
                <li>Sono vietati annunci contrastanti con la Legge, il buon costume, l'ordine pubblico ovvero lesivi del rispetto, della professionalità e dell'onore di terzi (inserzionisti e non).</li>
                <li>E' fatto divieto di pubblicare annunci aventi ad oggetto vendita di cose o servizi</li>
                <li>Non è consentito inserire testi o fotografie volgari o offensivi, riferimenti espliciti o impliciti a prestazioni sessuali a pagamento nè alcun tipo di contenuto a sfondo sessuale o pornografico</li>
                <li>E' vietato l'inserimento di annunci che riguardino prodotti contraffatti oppure copie illegali di cd/dvd, software, videogiochi e che violino i diritti di proprietà intellettuale (diritti d'autore, marchi, brevetti).</li>
                <li>E’ vietato l'inserimento di annunci di prodotti e/o servizi che possono violare la privacy di terze persone</li>
                <li>Non sono consentiti annunci riportanti testi diffamatori nei confronti di persone e/o società, testi razzisti e/o discriminanti o che siano solo commenti ad altri annunci pubblicati.</li>
                <li>L’Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS si riserva il diritto di rimuovere immediatamente, senza alcun avviso, inserzioni lesive di cui ai precedenti punti. L'inserzionista esonera l’Ass. Agenzia per lo sviluppo locale di San Salvario ONLUS da qualsivoglia responsabilità, civile, amministrativa, penale conseguente dalla pubblicazione di annunci lesivi ai sensi delle presenti condizioni.</li>
            </ol>
             
