<div class="col-md-3">
    <div class="common-card">
        <div class="card-main image-frame" style="background-image: url({{ Vite::asset('resources/images/categories/casa_elettrodomestici.svg') }})">
            &nbsp;
        </div>
...
<div class="col-md-8 col-md-offset-1">
    <div class="row">
        ...
        <div class="col-md-12 credits">
            ...
            <p>
                Consorzio Intercomunale Socio-Assistenziale Val Susa
            </p>
            <p class="intro">
                Partner
            </p>
