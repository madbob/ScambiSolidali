...
<div class="row primary-2">
    ...
    <div class="col-md-8 col-md-offset-1">
        ...
        <p>
            <a href="https://www.siwego.com/" target="_blank"><img src="{{ Vite::asset('resources/images/siwego.png') }}" alt="Siwego"></a>
        </p>
        <p>
            <a href="https://www.dicasaincosa.it/" target="_blank"><img src="{{ Vite::asset('resources/images/dicosaincosa.png') }}" alt="Di Casa in Cosa"></a> (Dalla Viva Voce APS)
        </p>
    </div>
</div>
